...
class FirefoxProfile(object):
    ...
    def __init__(self, name="default", port=DEFAULT_PORT,
                 template_profile=None, extension_path=os.path.join(os.path.dirname(__file__), '..', 'extension.zip')):
    ...
    def _launch_in_silent(self):
        ...
        subprocess.Popen([utils.get_firefox_start_cmd(), "-silent"], stderr=subprocess.PIPE, stdout=subprocess.PIPE).wait()
